...
def upgrade() -> None:
    ...
    op.create_table(
        "club_season_association",
        sa.Column("club_id", sa.Integer(), nullable=False),
        sa.Column("season_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["club_id"], ["club.id"], name=op.f("fk_club_season_association_club_id_club")
        ),
        sa.ForeignKeyConstraint(
            ["season_id"], ["season.id"], name=op.f("fk_club_season_association_season_id_season")
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.ForeignKeyConstraint(
            ["location_id"], ["location.id"], name=op.f("fk_matchdate_location_id_location")
        ),
        sa.ForeignKeyConstraint(
            ["season_id"], ["season.id"], name=op.f("fk_matchdate_season_id_season")
        ),
    ...
    op.create_table(
        "matchdate_away_team_assoc",
        sa.Column("match_date_id", sa.Integer(), nullable=False),
        sa.Column("team_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["match_date_id"],
            ["matchdate.id"],
            name=op.f("fk_matchdate_away_team_assoc_match_date_id_matchdate"),
        ),
        sa.ForeignKeyConstraint(
            ["team_id"], ["team.id"], name=op.f("fk_matchdate_away_team_assoc_team_id_team")
        ),
        sa.PrimaryKeyConstraint(
            "match_date_id", "team_id", name=op.f("pk_matchdate_away_team_assoc")
        ),
    )
    op.create_table(
        "matchdate_changelog",
        ...
        sa.ForeignKeyConstraint(
            ["location_id"],
            ["location.id"],
            name=op.f("fk_matchdate_changelog_location_id_location"),
        ),
        sa.ForeignKeyConstraint(
            ["match_date_id"],
            ["matchdate.id"],
            name=op.f("fk_matchdate_changelog_match_date_id_matchdate"),
        ),
        sa.PrimaryKeyConstraint(
            "match_date_id", "location_id", "date_time", name=op.f("pk_matchdate_changelog")
        ),
    )
    op.create_table(
        "matchdate_home_team_assoc",
        sa.Column("match_date_id", sa.Integer(), nullable=False),
        sa.Column("team_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["match_date_id"],
            ["matchdate.id"],
            name=op.f("fk_matchdate_home_team_assoc_match_date_id_matchdate"),
        ),
        sa.ForeignKeyConstraint(
            ["team_id"], ["team.id"], name=op.f("fk_matchdate_home_team_assoc_team_id_team")
        ),
        sa.PrimaryKeyConstraint(
            "match_date_id", "team_id", name=op.f("pk_matchdate_home_team_assoc")
        ),
    )
    op.create_table(
        "team_season_assoc",
        ...
        sa.Column("season_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["season_id"], ["season.id"], name=op.f("fk_team_season_assoc_season_id_season")
        ),
        sa.ForeignKeyConstraint(
            ["team_id"], ["team.id"], name=op.f("fk_team_season_assoc_team_id_team")
        ),
